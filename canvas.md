...
| 7 | **Phân công có tên** | • `Lê Văn Việt` — Product Lead, Canvas, Spec.md, System Prompt<br>• `Đặng Đỉnh Đoàn` — Data & Evidence mining, khảo sát lớp, Golden set<br>• `Ngô Anh Khoa` — Backend/API AI call thật, Validator logic<br>• `Mai Quang Dúng` — Frontend UI Mock/Flow, User Testing & Feedback log (R6) |
