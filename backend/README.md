...
- Muốn có trace **trong repo** cho TA xem: `python ../scripts/export_trace_sample.py --limit 2` → `eval/traces-sample/*.json` (đã thay nguyên văn đoạn bài giảng bằng mã đoạn).
