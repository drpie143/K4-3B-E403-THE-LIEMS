...
Cách chạy:
    .\codebase\backend\.venv\Scripts\python.exe codebase/scripts/test_gemini.py
"""
...
def main():
    ...
    if not key:
        print("❌ Chưa tìm thấy GEMINI_API_KEY trong file codebase/backend/.env!")
        print("👉 Hãy mở codebase/backend/.env và điền GEMINI_API_KEY của bạn vào dòng 17.")
        return
    ...
    try:
        with httpx.Client(timeout=20.0) as client:
            ...
            if resp.status_code == 200:
                ...
                print(f"   .\\codebase\\backend\\.venv\\Scripts\\python.exe codebase/scripts/sync_to_supabase.py")
            else:
