...
(function () {
  ...
  function openSource(id) {
    ...
    if (!local) box.appendChild(h("p", { class: "muted", html: "Đang hiện <b>tóm tắt</b>. Chạy <code>python app/scripts/build_local_data.py</code> để xem nguyên văn trên máy (file sinh ra không được commit)." }));
    openOverlay("#sourceView");
  }
